...
import RadiationCircle from '../../FastX/SpecialEffects/RadiationCircle'

const title = '辐射圈'
const getApi = createLazySfxApi(RadiationCircle)

interface RadiationForm {
  id: string
  longitude: number
  latitude: number
  height: number
...
function createDefaultForm(): RadiationForm {
  return {
    id: '',
    longitude: 120.95,
    latitude: 23.75,
...
function buildOptions(form: RadiationForm) {
  return {
      ...
      <div class="hzd-dialog-body">
        ...
        <div class="hzd-shell">
          <section class="hzd-pane hzd-pane--form">
            ...
            <div class="hzd-pane-scroll hzd-scroll-skin">
              <div class="hzd-form-fields">
                ...
                <div class="hzd-field-row">
                  <span class="hzd-field-label">波纹数量</span>
                  <div class="hzd-field-control">
                    <a-input-number v-model:value="form.count" class="hzd-control-fill" size="small" :min="1" :max="20" />
                  </div>
                </div>
                <div class="hzd-field-row">
                  <span class="hzd-field-label">渐变强度</span>
                  <div class="hzd-field-control hzd-field-control--slider">
                    <a-slider v-model:value="form.gradient" class="hzd-slider-fill" :min="0" :max="1" :step="0.05" />
                  </div>
                </div>
                <div class="hzd-field-row">
          ...
          <section class="hzd-pane hzd-pane--table">
            <div class="hzd-pane-title">辐射圈列表</div>
