...
watch(activeMenuKey, () => {
  ...
  if (v && !v.isDestroyed()) {
    ...
    window.FastX?.StraightArrow?.clear(v)
    window.FastX?.StraightArrowCollection?.clear(v)
    window.FastX?.FineStraightArrow?.clear(v)
    window.FastX?.FineStraightArrowCollection?.clear(v)
    window.FastX?.CurveArrow?.clear(v)
    window.FastX?.CurveArrowCollection?.clear(v)
    window.FastX?.AttackDirectionArrow?.clear(v)
    window.FastX?.AttackDirectionArrowCollection?.clear(v)
    window.FastX?.DoubleArrow?.clear(v)
    window.FastX?.DoubleArrowCollection?.clear(v)
    window.FastX?.SwallowtailAttackArrow?.clear(v)
    window.FastX?.SwallowtailAttackArrowCollection?.clear(v)
    window.FastX?.PincerArrow?.clear(v)
    window.FastX?.PincerArrowCollection?.clear(v)
  ...
  window.FastX?.StraightArrow?.pruneInvalid()
  window.FastX?.StraightArrowCollection?.pruneInvalid()
  window.FastX?.FineStraightArrow?.pruneInvalid()
  window.FastX?.FineStraightArrowCollection?.pruneInvalid()
  window.FastX?.CurveArrow?.pruneInvalid()
  window.FastX?.CurveArrowCollection?.pruneInvalid()
  window.FastX?.AttackDirectionArrow?.pruneInvalid()
  window.FastX?.AttackDirectionArrowCollection?.pruneInvalid()
  window.FastX?.DoubleArrow?.pruneInvalid()
  window.FastX?.DoubleArrowCollection?.pruneInvalid()
  window.FastX?.SwallowtailAttackArrow?.pruneInvalid()
  window.FastX?.SwallowtailAttackArrowCollection?.pruneInvalid()
  window.FastX?.PincerArrow?.pruneInvalid()
  window.FastX?.PincerArrowCollection?.pruneInvalid()
