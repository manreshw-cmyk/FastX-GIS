...
| **基础标绘** | 点、线、面、圆、扇形、矩形、柱体、走廊、跑道、椭球、墙、Billboard、标牌 Overlay、模型、Box、PolylineVolume、Plane、Path、军事箭头、2/3维热力图、点聚合等 |
| **量算分析** | 空间/地表/投影等距离测量、空间/投影等面积测量、三角测量、方位角测量、直线通视、圆形通视、多点通视、视域分析、等高线分析、坡度贴图分析、坡向/坡面分析、地形剖面分析、挖填方分析、淹没分析、缓冲区分析 |
| **高性能标绘** | 基础标绘中所有功能均支持 Primitive 高性能批量API |
| **特效集合** | 辐射圈、圆扩散、电子围栏、多边形扩散墙、雷达发射波、半球雷达扫描、空中扫描雷达、扇弧形雷达扫描、双面视锥体、双圆锥环面扫描体、四方视椎体、圆锥扫描特效、抛物面雷达、环形雷达扫描、火力范围、扩散雷达、瞄准特效、爆炸、帧动画等 |
| **气象特效** | 全局雨、全局雪、全局大雾 |
| **卫星轨迹** | 轨迹与 Mover 运动体 |
