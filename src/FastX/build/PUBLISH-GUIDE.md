...
3. **包体积**：含完整 Cesium，`fastx-sdk-1.0.2.tgz` 约 **15～25 MB**，属正常现象。
...
```bash
# 查看包内文件列表
tar -tzf fastx-sdk-1.0.2.tgz

# 在其它项目中试装
npm install /path/to/fastx-sdk-1.0.2.tgz
```
...
**Q：`fastx-sdk-1.0.2.tgz` 要提交 Git 吗？**  
