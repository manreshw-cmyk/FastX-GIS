...
const TOOLBAR_ICONS = {
  layers:
    '<path d="M12 4 4 8.5v7L12 20l8-4.5v-7L12 4Zm0 2.2 5.5 3.1v5.4L12 18 6.5 14.7V9.3L12 6.2Z"/><path d="M12 8 8 10v4l4 2 4-2v-4l-4-2Z" opacity="0.55"/>',
  atmosphere:
...
const TOOLBAR_ITEMS: ToolbarItem[] = [
  { kind: "button", key: "layers", title: "图层", icon: "layers", muted: true },
  {
    kind: "button",
    key: "scene",
    title: "二三维",
